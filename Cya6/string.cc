 ...
 * @brief Archivo de desarrollo de la clase string.cc. Se desarrollan los metodos 
 * de la clase string. Debido al uso de nombres autodescriptivos solo sera comentado 
 * aquello que sea necesaria su explicacion.
 * @version 0.1
 * @date 2022-11-09
 * 
